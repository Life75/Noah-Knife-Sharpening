<template>
  <div id="instructions" class="rounded shadow bg-[#3b3837]">
    <div class="py-5">
      <p class="text-center text-4xl font-extrabold">By Appointment only</p>
    </div>
    <div class="m-7">
      ...
      <p class="text-center text-3xl py-10 font-extrabold">Options for services</p>
      <span class="md:flex justify-center">
        <div class="max-w-md py-4 px-8 bg-gray-50 shadow-lg rounded-lg mb-20">
          
          <div>
            <h2 class="text-gray-800 text-4xl font-semibold">Mobile</h2>
            <p class="mt-2 text-xl text-gray-600">
                For mobile, I will come out to you with my equipment and sharpen your knives while you're in the comfort of your own home. 
            </p>
            <p class="mt-2 text-xl text-gray-600">
        ...
        <div class="max-w-md py-4 px-8 bg-gray-50  shadow-lg rounded-lg mb-20">
          <div>
            <h2 class="text-gray-800 text-4xl font-semibold">Drop Off</h2>
            <p class="mt-2 text-xl text-gray-600">
      ...
      <div class="text-center">
        Prices: $5 minimum per blade $1 per inch after 5 inches $1.5 per inch for serrated //fix
      </div>
    </div>
